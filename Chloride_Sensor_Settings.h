...
#ifndef __CHILI_SENSOR_SETTINGS_H
#define __CHILI_SENSOR_SETTINGS_H

#include "TI_LMP91000.h"
#include "eChem.h"

// Polling period in ms
#define POLL_PERIOD                             250
...
#define SENS_DENOM_1                            275000        // R_TIA x 100
...
#define SENS_OPERATIONAL_MODE                   OP_MODE_TEMP_MEAS_TIA_ON // Lowest power mode that still has temperature but does not bias electrodes
#define SENS_FEEDBACK_GAIN                      TIA_GAIN_2_75K_OHM // Try to increase input impedance as mucch as possible
#define SENS_RLOAD                              R_LOAD_10_OHM // Try to separate RE and WE as much as possible
#define SENS_INT_Z_REF_DIVIDER                  INT_Z_SEL_50_PERCENT // Does not really matter what this is set to
...
// Predifined minimum current to allow state iteration
#define SENS_TOP_ZERO_LIMIT                     5
#define SENS_BOT_ZERO_LIMIT                     -5
...
#define SENS_TYPE                               CHLORIDE_SENSOR_TYPE    
