...
#define DEFAULT_FAST_ADV_DURATION             3000
...
#define DEFAULT_SENS_PERIOD                   POLL_PERIOD
...
//  uint8  intZSel;
  ...
  // Setup the Sensor Characteristic Values
  {
    ...
    value8 = (SENS_FET_SHORT | SENS_OPERATIONAL_MODE);
...
#ifdef GLUCOSE_SENSOR
               LMP91000_I2CInitialSetup(SENS_FEEDBACK_GAIN , SENS_RLOAD, (SENS_REF_SOURCE | BIAS_SIGN_POSITIVE| BIAS_22_PERCENT), SENS_INT_Z_REF_DIVIDER, (SENS_FET_SHORT | OP_MODE_TEMP_MEAS_TIA_ON));
                LMP91000_I2CInitialSetup(SENS_FEEDBACK_GAIN , SENS_RLOAD, (SENS_REF_SOURCE | BIAS_SIGN_POSITIVE| BIAS_22_PERCENT), SENS_INT_Z_REF_DIVIDER, (SENS_FET_SHORT | OP_MODE_TEMP_MEAS_TIA_ON));
               LMP91000_I2CInitialSetup(SENS_FEEDBACK_GAIN , SENS_RLOAD, (SENS_REF_SOURCE | BIAS_SIGN_POSITIVE| BIAS_22_PERCENT), SENS_INT_Z_REF_DIVIDER, (SENS_FET_SHORT | OP_MODE_TEMP_MEAS_TIA_ON));
               LMP91000_I2CInitialSetup(SENS_FEEDBACK_GAIN , SENS_RLOAD, (SENS_REF_SOURCE | BIAS_SIGN_POSITIVE| BIAS_22_PERCENT), SENS_INT_Z_REF_DIVIDER, (SENS_FET_SHORT | OP_MODE_TEMP_MEAS_TIA_ON));
#else
                 // Set up the LMP91000 and MAX4461
//  get_SensHardwareSettings (&modeOp, &tiaGain, &rLoad, &refVoltageSource, &intZSel); // Get previous settings
  LMP91000_I2CInitialSetup(SENS_FEEDBACK_GAIN , SENS_RLOAD, SENS_REF_SOURCE, SENS_INT_Z_REF_DIVIDER, (SENS_FET_SHORT | SENS_OPERATIONAL_MODE));
  LMP91000_I2CInitialSetup(SENS_FEEDBACK_GAIN , SENS_RLOAD, SENS_REF_SOURCE, SENS_INT_Z_REF_DIVIDER, (SENS_FET_SHORT | SENS_OPERATIONAL_MODE));
  LMP91000_I2CInitialSetup(SENS_FEEDBACK_GAIN , SENS_RLOAD, SENS_REF_SOURCE, SENS_INT_Z_REF_DIVIDER, (SENS_FET_SHORT | SENS_OPERATIONAL_MODE));
  LMP91000_I2CInitialSetup(SENS_FEEDBACK_GAIN , SENS_RLOAD, SENS_REF_SOURCE, SENS_INT_Z_REF_DIVIDER, (SENS_FET_SHORT | SENS_OPERATIONAL_MODE));
